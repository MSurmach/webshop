package com.intexsoft.webshop.feedbackservice.config;
...
public class RabbitMQConfig {
    @Value("${rmq.event.feedback.exchange}")
    private String eventFeedbackExchangeName;
    ...
    public TopicExchange eventExchange() {
        return new TopicExchange(eventFeedbackExchangeName);
    }
