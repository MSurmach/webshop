...
@Slf4j
public class IncrementProductOrderQuantity implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) {
        ...
        log.info("IN: try to increment product order quantity for products with ids in = {}", productIds);
        orderOrchestratorCommandProducer.produceChangeProductOrderQuantityCommand(
                eventToCommandMapper.toChangeProductOrderQuantityCommand(
                        ...
                        ChangeProductOrderQuantityType.INCREMENT));
    }
}